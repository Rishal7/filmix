...
export const Header = () => {
  ...
  const activeClass =
    "text-base block py-2 pr-4 pl-3 text-white bg-gray-600 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white";
  const inActiveClass =
      ...
      <nav className="bg-white border-b-2 border-gray-200 px-2 sm:px-4 py-2 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
        <div className="flex flex-wrap justify-between items-center mx-auto">
          <Link to="/" className="flex items-center">
            <img
              src={Logo}
              className="h-8 mr-2 sm:h-9 rounded-full"
              alt="Logo"
            />
